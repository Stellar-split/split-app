  ...
  return (
    <>
      ...
      <div className="w-full max-w-sm mx-auto p-4 sm:p-6">
        <div className="rounded-lg bg-gray-800 border border-gray-700 p-4 sm:p-6">
            ...
            {invoice.status === "Pending" && publicKey && (
              <form onSubmit={handlePay} className="pt-2 border-t border-gray-700">
                ...
                <button
                  ...
                  className="w-full min-h-10 px-4 py-2 rounded-lg bg-indigo-600 hover:bg-indigo-500 font-semibold text-sm transition-colors disabled:opacity-50"
                >
