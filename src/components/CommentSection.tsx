    ...
    <section className="mb-8">
          ...
          {comments.map((c) => (
            ...
            >
              ...
              <button
                ...
                className="flex-shrink-0 text-gray-600 hover:text-red-400 transition-colors text-xs mt-0.5"
              >
                ✕
              </button>
            </li>
      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-2">
        <textarea
          ...
          rows={2}
          className="w-full bg-gray-800 border border-gray-700 rounded-lg px-3 py-2 text-sm resize-none focus:outline-none focus:ring-2 focus:ring-indigo-500"
        />
        <button
          type="submit"
          disabled={!text.trim()}
          className="self-end px-4 py-2 rounded-lg bg-indigo-600 hover:bg-indigo-500 text-sm font-semibold transition-colors disabled:opacity-40"
        >
          Add Note
        </button>
      </form>
