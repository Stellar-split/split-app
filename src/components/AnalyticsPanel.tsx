        ...
        <div className="mt-5 space-y-5">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
            <div className="bg-gray-800 rounded-lg p-4">
              <p className="text-xs text-gray-400 mb-1">Total USDC Sent</p>
              <p className="text-lg font-semibold">{formatAmount(stats.totalSent)}</p>
            </div>
            <div className="bg-gray-800 rounded-lg p-4">
              <p className="text-xs text-gray-400 mb-1">Total USDC Received</p>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
            ...
            <div className="bg-green-500/10 border border-green-500/20 rounded-lg p-4">
              <p className="text-xs text-green-300 mb-1">Released</p>
          ...
          {chartData.length > 0 && (
            <div className="bg-gray-800 rounded-lg p-4 overflow-x-auto">
              <p className="text-sm text-gray-400 mb-3">Invoices by Week (Last 30 Days)</p>
