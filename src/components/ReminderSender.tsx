...
export default function ReminderSender({
  ...
  if (!open) {
    return (
      <button
        ...
        className="min-h-11 px-4 py-2 rounded-lg bg-amber-600 hover:bg-amber-500 text-sm font-semibold transition-colors"
        aria-label="Send a payment reminder"
      >
        Send Reminder
      </button>
    );
  ...
  return (
    <section
      ...
      className="mb-8 bg-gray-900 rounded-xl p-4 sm:p-5 border border-amber-700/40"
    >
      <div className="flex items-center justify-between mb-3">
        <h2 id="reminder-heading" className="text-base font-semibold text-amber-300">
          Send Reminder
        </h2>
        <button
          type="button"
      ...
      <div className="bg-gray-800 rounded-lg p-3 mb-4 text-sm text-gray-200 break-words leading-relaxed">
        {reminderText}
      </div>
